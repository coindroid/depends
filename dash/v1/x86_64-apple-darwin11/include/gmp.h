...
#define __GMP_CC "clang -target x86_64-apple-darwin11 -mmacosx-version-min=10.8 --sysroot /prj/clean_dash/depends/SDKs/MacOSX10.11.sdk -mlinker-version=253.9"
#define __GMP_CFLAGS "-pipe -O2    "
